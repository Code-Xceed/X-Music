 ...
 *  Ã¢â‚¬Â¢ Minecraft ItemStack icons Ã¢â‚¬â€ pixel-perfect MC art for static icons
 *  Ã¢â‚¬Â¢ Scaled unicode Ã¢â‚¬â€ for icons that need per-state color control
...
public final class IconRenderer {
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Pre-built ItemStacks (no per-frame allocation) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Sidebar Icons (MC items) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

    public static void home(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.RED_BED), x, y, w, h);
    }

    public static void search(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.COMPASS), x, y, w, h);
    }

    public static void library(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.BOOK), x, y, w, h);
    }

    public static void groups(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.PLAYER_HEAD), x, y, w, h);
    }

    public static void downloads(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.HOPPER), x, y, w, h);
    }

    public static void settings(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.COMPARATOR), x, y, w, h);
    }

    // Ã¢â€â‚¬Ã¢â€â‚¬ Playback Icons (unicode Ã¢â‚¬â€ need color control for active/hover) Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ PlayerBar Right Icons (MC items) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

    public static void volume(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.NOTE_BLOCK), x, y, w, h);
    }

    public static void loop(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.REPEATER), x, y, w, h);
    }

    // Ã¢â€â‚¬Ã¢â€â‚¬ Search Tab Icons (MC items where possible) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    public static void durationFilter(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.CLOCK), x, y, w, h);
    }

    public static void history(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.SPYGLASS), x, y, w, h);
    }

    public static void recent(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.MUSIC_DISC_13), x, y, w, h);
    }

    public static void autoPlay(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.LEVER), x, y, w, h);
    }

    // Ã¢â€â‚¬Ã¢â€â‚¬ Track Row Icons (unicode heart Ã¢â‚¬â€ needs color; MC item download) Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    public static void download(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.CHEST), x, y, w, h);
    }
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Utility Icons (MC items) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

    public static void clear(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.BARRIER), x, y, w, h);
    }

    public static void url(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.CHAIN), x, y, w, h);
    }

    public static void paste(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.PAPER), x, y, w, h);
    }

    public static void copy(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.WRITABLE_BOOK), x, y, w, h);
    }
    ...
    public static void nowPlaying(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.MUSIC_DISC_CAT), x, y, w, h);
    }

    // Ã¢â€â‚¬Ã¢â€â‚¬ Library Tab Icons Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    public static void playlistBook(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.KNOWLEDGE_BOOK), x, y, w, h);
    }

    public static void mapIcon(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.FILLED_MAP), x, y, w, h);
    }
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Home Page Icons Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

    public static void fire(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.BLAZE_POWDER), x, y, w, h);
    }
    ...
    public static void star(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.NETHER_STAR), x, y, w, h);
    }

    // Ã¢â€â‚¬Ã¢â€â‚¬ Category Disc Icons (different colored MC discs) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

    public static void discMostPlayed(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.MUSIC_DISC_CHIRP), x, y, w, h);    // red disc Ã¢â‚¬â€ hot/fire
    }

    public static void discRecent(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.MUSIC_DISC_BLOCKS), x, y, w, h);   // orange disc Ã¢â‚¬â€ recent/warm
    }

    public static void discAlbums(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.MUSIC_DISC_MELLOHI), x, y, w, h);  // pink disc Ã¢â‚¬â€ albums
    }

    public static void discArtists(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.MUSIC_DISC_STAL), x, y, w, h);     // brown disc Ã¢â‚¬â€ artists
    }

    public static void discPlaylists(GuiGraphics g, Font f, int x, int y, int w, int h, int c) {
        item(g, new ItemStack(Items.MUSIC_DISC_WAIT), x, y, w, h);     // purple disc Ã¢â‚¬â€ playlists
    }
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Generic helpers Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Core: MC Item Rendering Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Core: Scaled Unicode Rendering Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
