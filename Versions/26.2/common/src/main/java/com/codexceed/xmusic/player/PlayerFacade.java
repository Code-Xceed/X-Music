...
public final class PlayerFacade {
    ...
    public boolean playQueue(List<TrackRef> tracks, int startIndex) {
        ...
        if (mc.gui.screen() instanceof com.codexceed.xmusic.gui.screen.XMusicScreen) {
            com.codexceed.xmusic.gui.GuiRoute route = ((com.codexceed.xmusic.gui.screen.XMusicScreen) mc.gui.screen()).getActiveRoute();
